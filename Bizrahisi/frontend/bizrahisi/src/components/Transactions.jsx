...
const Transactions = () => {
    ...
    return (
        <div className={`Transactions ${darkMode ? 'dark-mode' : 'light-mode'}`}>
            ...
            <div className="Sales_Overview">
                <div className="SalesOverviewContent">
                    <h2>Sales Overview</h2>
                    <div className="SalesTransaction_Info">
                        <div className="SalesTransaction_Text">
                            ...
                            <div className="SalesTransaction_Count">{transactionStats.sales_transactions} Transactions</div>
                        </div>
                    </div>

                    <div className="SalesCustomer_Info">
                        <div className="SalesCustomer_Text">
                            ...
                            <div className="SalesCustomer_Count">{transactionStats.customers_number} Customers</div>
                        </div>
                    </div>
                    ...
                    <div className="Sales">
                        <div className="Sales_Text">
                            <div className="Sales_Logo">
                                <svg width="30" height="20" viewBox="0 0 49 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M30.9314 15.9137H18.0675C17.6892 15.9137 17.3818 16.118 17.3818 16.3695V30.5442C17.3818 30.7957 17.6892 31 18.0675 31H30.9304C31.3087 31 31.6161 30.7957 31.6161 30.5442L31.6165 16.3695C31.6165 16.118 31.3092 15.9137 30.9308 15.9137H30.9314ZM18.7544 22.9702V21.5175H30.2467V22.971H18.7544V22.9702ZM30.2456 23.882V25.3355H18.7544V23.882H30.2456ZM18.7544 20.6059V19.1524H30.2467V20.6059H18.7544ZM18.7544 26.2473H30.2467V27.7008H18.7544V26.2473ZM30.2456 16.8253V18.2409L18.7544 18.2406V16.825L30.2456 16.8253ZM18.7544 30.0876V28.6121H30.2467L30.2463 30.0876H18.7544ZM48.3143 8.82588H35.4514C35.0731 8.82588 34.7657 9.03018 34.7657 9.28167L34.7653 30.5434C34.7653 30.7949 35.0727 30.9992 35.451 30.9992H48.3139C48.6922 30.9992 48.9996 30.7949 48.9996 30.5434L49 9.28167C49 9.03019 48.6938 8.82588 48.3143 8.82588ZM36.1372 20.6046V19.1511H47.6295V20.6046H36.1372ZM47.6295 21.5162V22.9697H36.1372V21.5162H47.6295ZM36.1372 18.2401V16.7866H47.6295V18.2401H36.1372ZM36.1372 15.875V14.4215H47.6295V15.875H36.1372ZM36.1372 23.8813H47.6295V25.3348H36.1372V23.8813ZM47.6295 13.5095H36.1372V12.056H47.6295V13.5095ZM36.1372 26.2468H47.6295V27.7003H36.1372V26.2468ZM47.6295 9.73707V11.1442H36.1372V9.73707H47.6295ZM36.1372 30.0871V28.6116H47.6295V30.0871H36.1372ZM13.5486 23H0.685681C0.307367 23 0 23.2044 0 23.4558V30.5435C0 30.795 0.307357 30.9993 0.685681 30.9993H13.5486C13.9269 30.9993 14.2343 30.795 14.2343 30.5435V23.4565C14.2347 23.2048 13.9269 23.0005 13.5486 23.0005V23ZM1.37148 26.274H12.8638V27.7243H1.37148V26.274ZM12.8638 23.9119V25.3622H1.37148V23.9119H12.8638ZM1.37148 30.0873V28.637H12.8638V30.0873H1.37148ZM26.7803 11.2935L42.3986 0.911577H35.225C34.8467 0.911577 34.5393 0.707271 34.5393 0.455789C34.5393 0.204307 34.8466 0 35.225 0H44.0547C44.433 0 44.7404 0.204307 44.7404 0.455789V6.32512C44.7404 6.57659 44.433 6.78091 44.0547 6.78091C43.6764 6.78091 43.369 6.5766 43.369 6.32512V1.55659L27.2659 12.2607C26.9984 12.4385 26.5643 12.4385 26.2956 12.2607L21.1989 8.87284L5.43256 19.3538C5.29902 19.4425 5.12281 19.4876 4.94781 19.4876C4.7728 19.4876 4.597 19.4428 4.46305 19.3538C4.19556 19.176 4.19556 18.8874 4.46305 18.7096L20.7152 7.90641C20.9827 7.7286 21.4168 7.7286 21.6855 7.90641L26.7803 11.2935Z" fill="#34A853"/>
                                </svg>
                            </div>
                            <div className="Sales_Count">Ksh {transactionStats.total_sales} Sales</div>
                        </div>
                    </div>

                    <div className="Sales_Profit">
                        <div className="SalesProfit_Text">
                            <div className="SalesProfit_Logo">
                                <svg width="30" height="20" viewBox="0 0 37 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M26.658 11.1921C26.6584 11.0576 26.5805 10.9457 26.4752 10.8716C26.3696 10.7972 26.2288 10.7542 26.0779 10.7542H21.4709C21.3201 10.7542 21.1793 10.7972 21.0736 10.8716C20.9683 10.9457 20.8903 11.0574 20.8903 11.1918V25.6614C20.8903 25.7964 20.9681 25.9082 21.0737 25.9822C21.1795 26.0563 21.3203 26.0988 21.4709 26.0988H26.0777C26.2283 26.0988 26.3691 26.0563 26.4749 25.9821C26.5804 25.9081 26.6583 25.7963 26.6583 25.6614L26.658 11.1921ZM26.658 11.1921L26.558 11.1918L26.658 11.1918V11.1921ZM32.5435 2.4352L32.2383 3.90996L32.2382 3.91007C32.2108 4.04345 32.2652 4.16569 32.3581 4.25306C32.4501 4.3395 32.5826 4.39618 32.7316 4.41174C32.7314 4.41171 32.7312 4.41169 32.731 4.41167L32.5435 2.4352ZM31.6733 1.84057C23.1495 7.22119 12.9415 11.396 1.2989 14.2458L1.29851 14.2459C1.15509 14.2816 1.03607 14.3569 0.96584 14.4592C0.911367 14.5386 0.888094 14.6326 0.906363 14.7271L0.89486 14.7336L0.937097 14.8186C1.02965 15.005 1.26024 15.1006 1.4798 15.1006C1.53942 15.1006 1.60085 15.0944 1.66242 15.0787C1.66259 15.0786 1.66277 15.0786 1.66295 15.0785L1.63809 14.9817L31.6733 1.84057ZM6.18737 18.1039V18.0973H6.08737H1.48061C1.32987 18.0973 1.18907 18.1399 1.08329 18.2141C0.97773 18.2882 0.9 18.4 0.9 18.5349V25.6614C0.9 25.7963 0.977631 25.9081 1.08321 25.9822C1.18898 26.0563 1.32978 26.0988 1.48061 26.0988H6.08737C6.238 26.0988 6.37878 26.0563 6.48456 25.9821C6.59011 25.9081 6.66798 25.7963 6.66798 25.6614V18.5349C6.66798 18.4 6.59013 18.2882 6.48455 18.2142C6.40259 18.1567 6.29963 18.1183 6.18737 18.1039ZM32.0465 7.95891H35.4926V25.2238H32.0465V7.95891ZM36.0732 7.08262H31.4665C31.3157 7.08262 31.1749 7.12554 31.0692 7.19982C30.9638 7.27384 30.8858 7.38558 30.8858 7.52002V25.6612C30.8858 25.7961 30.9635 25.9079 31.0691 25.982C31.1748 26.0562 31.3156 26.0986 31.4665 26.0986H36.0732C36.224 26.0986 36.3647 26.0561 36.4705 25.9819C36.5761 25.9079 36.6538 25.7961 36.6538 25.6612V7.52002C36.6538 7.38566 36.5758 7.27393 36.4705 7.1999C36.3648 7.1256 36.224 7.08262 36.0732 7.08262ZM22.0512 11.6305H25.4973V25.2238H22.0512V11.6305ZM12.0559 14.5985H15.502V25.2234H12.0559V14.5985ZM16.0827 13.724H11.4759C11.3253 13.724 11.1845 13.7666 11.0787 13.8408C10.9732 13.9148 10.8953 14.0266 10.8953 14.1614V25.6612C10.8953 25.7962 10.9731 25.908 11.0787 25.982C11.1845 26.0561 11.3253 26.0986 11.4759 26.0986H16.0827C16.2333 26.0986 16.3741 26.0561 16.4798 25.9819C16.5854 25.9079 16.6633 25.7961 16.6633 25.6612V14.1614C16.6633 14.0265 16.5854 13.9147 16.4798 13.8407C16.374 13.7665 16.2333 13.724 16.0827 13.724ZM5.50729 25.2238H2.06119V18.9727H5.50729V25.2238Z" fill="#34A853" stroke="#34A853" strokeWidth="0.2"/>
                                </svg>
                            </div>
                            <div className="SalesProfit_Count">Ksh {transactionStats.total_earnings} Profit</div>
                        </div>
                    </div>
                </div>
            </div>

            <div className="TransactionsPurchase_Overview">
                <div className="TransactionsPurchaseOverviewContent">
            ...
            <div className="TransactionsTransactions_History">
                {/* Table of Transactions History */}
                    ...
                    <table>
                        ...
                        <tbody>
                            {transactionsData.map((item) => (
                                <tr key={item.code} className="TransactionsHistory_Row">
                                    <td>{item.code}</td>
            ...
            <TransactionDetails
                ...
                details={selectedTransaction} // Access the first element if it's an array
            />
        </div>
    );
};
